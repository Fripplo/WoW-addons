...
local L = LibStub("AceLocale-3.0"):NewLocale("NauticusLichking", "enUS", true)
...
L["NauticusLichking Options"] = true
L["Alarm is now: "] = true
L["ON"] = true
L["OFF"] = true
...
L["New version available! Visit github.com/psynct/NauticusLichking"] = true

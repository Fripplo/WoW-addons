...
local L = LibStub("AceLocale-3.0"):NewLocale("NauticusLichking", "ruRU")
...
L["NauticusLichking Options"] = "Настройки NauticusLichking"
...
L["New version available! Visit github.com/psynct/NauticusLichking"] = "Доступна новая версия NauticusLichking! Забрать можно здесь github.com/psynct/NauticusLichking"
